...
-- Started on 2025-02-03 16:48:48
...
INSERT INTO public.immobile VALUES (35, 'hgfgh', 'Appartamento', 'fghjfgh', 'Affitto', 3468, 0, 0, 0, 0, 'wytre', 'Catanzaro', 38.9641568, 16.2990689, '{"immobiliImages/35/Screenshot 2023-07-02 110158.png"}', 'sofa');
...
SELECT pg_catalog.setval('public.immobili_id_seq', 35, true);
...
SELECT pg_catalog.setval('public.messaggio_id_seq', 2, true);
...
-- Completed on 2025-02-03 16:48:49
